...
TextureType Entity::getTextureType() const {
    return mTextureType;
}
Direction Entity::getDirection() const {
    return mDirection;
}
int Entity::getFrameSpeed() const {
    return mFrameSpeed;
}
float Entity::getJumpingPower() const {
...
bool Entity::isCollidingTop() const {
    return mIsCollidingTop;
}
bool Entity::isCollidingBottom() const {
    return mIsCollidingBottom;
}

std::map<Direction, std::vector<int>> Entity::getAnimationAtlas() const {
...
void Entity::setMovement(Vector2 newMovement) {
    mMovement = newMovement;
}
void Entity::setAcceleration(Vector2 newAcceleration) {
...
void Entity::setColliderDimensions(Vector2 newDimensions) {
    mColliderDimensions = newDimensions;
}
void Entity::setSpriteSheetDimensions(Vector2 newDimensions) {
    mSpriteSheetDimensions = newDimensions;
}
void Entity::setSpeed(int newSpeed) {
    mSpeed = newSpeed;
}
void Entity::setFrameSpeed(int newSpeed) {
    mFrameSpeed = newSpeed;
}
void Entity::setJumpingPower(float newJumpingPower) {
